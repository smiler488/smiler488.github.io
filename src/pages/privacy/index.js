...
const COPY = {
  en: {
    ...
    pageDescription:
      "How the site-wide visitor map and MapMyVisitors handle data.",
    eyebrow: "Privacy · Visitor analytics",
    title: "Clear boundaries for the visitor map.",
    intro:
    ...
    summaries: [
      {
        label: "Service",
        value: "MapMyVisitors map image in a sandboxed frame",
      },
      {
        label: "Purpose",
    ...
    isolationTitle: "What the map cannot access",
    isolationText:
  ...
  zh: {
    pageTitle: "隐私与访客统计",
    pageDescription: "说明全站访客地图及 MapMyVisitors 如何处理数据。",
    eyebrow: "隐私 · 访客统计",
    title: "明确访客地图的数据边界。",
    intro:
      "每个页面的底栏都会自动加载 MapMyVisitors 访客地图。本页说明会发送哪些信息、使用目的，以及隔离挂件无法访问的内容。",
    updated: "最后更新 · 2026 年 7 月 16 日",
    summaryLabel: "隐私摘要",
    summaries: [
      {
        label: "第三方服务",
        value: "沙箱隔离的 MapMyVisitors 地图图片",
      },
      {
        label: "使用目的",
        value: "访客大致位置与汇总访问统计",
    ...
    automaticText:
      "只要打开包含全局底栏的页面，访客地图图片就会自动加载，无需点击。因此，即使底栏尚未出现在屏幕中，相关网络请求也会在访问期间开始。MapMyVisitors 的 JavaScript 不会在父页面中运行；点击地图会打开服务方的公开统计页。",
    ...
    useText:
      "本网站使用这些信息展示实时地图、了解访客的大致地理来源并查看汇总流量。请求会直接发送给 MapMyVisitors。本网站不会获得你的精确 GPS 位置，也不会出售访客数据。服务方的数据保存、删除和权利请求以 MapMyVisitors 的政策为准。",
    isolationTitle: "访客地图无法访问的内容",
    isolationText:
      "服务方内容以图片形式运行在不具备同源权限和摄像头权限的不透明沙箱中，无法直接读取父页面 DOM、浏览器中保存的 AI 密钥、摄像头画面或上传到科研工具的文件；服务方只会收到返回和统计地图图片所需的网络请求元数据。",
